...
<div class="p-4 sm:ml-64">
    <div class="px-10 py-6 mt-1 flex flex-col md:flex-row items-center h-auto rounded-md bg-white border border-gray-200 p-5">
        ...
        <x-breadcrumb parent="Data Master" item="Program Studi" />
    </div>
                ...
                <table class="mb-4 table-auto w-full border-collapse border border-gray-200">
                    <thead class="bg-gray-100">
                        <tr class="text-center">
                            ...
                            <th class="border border-gray-300 px-4 py-2 whitespace-nowrap">Kode Program Studi</th>
                            <th class="border border-gray-300 px-4 py-2 whitespace-nowrap">Nama Program Studi</th>
                    ...
                    <tbody>
                        @foreach($programStudi as $prodi)
                            <tr class="hover:bg-gray-50">
                                <td class="border border-gray-300 px-4 py-2 text-center whitespace-nowrap">{{ $loop->iteration + ($programStudi->currentPage() - 1) * $programStudi->perPage() }}</td>
                                <td class="border border-gray-300 px-4 py-2 whitespace-nowrap">{{ $prodi->kode_prodi }}</td>
                                <td class="border border-gray-300 px-4 py-2 whitespace-nowrap">{{ $prodi->nama_prodi }}</td>
                                <td class="border border-gray-300 px-4 py-2">
                                    <div class="flex justify-center space-x-2">
                                        <button data-modal-target="editModal-{{ $prodi->id }}" data-modal-toggle="editModal-{{ $prodi->id }}" class="text-sm flex items-center justify-center w-full px-3 py-2 bg-yellow-400 text-white rounded-lg hover:bg-yellow-600 transition duration-200">
