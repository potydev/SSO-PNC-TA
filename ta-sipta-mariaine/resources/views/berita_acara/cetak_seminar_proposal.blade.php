...
<body>
    <div class="container">
        ...
        <div class="title-box" style="letter-spacing: 0.5px;">
            BERITA ACARA SIDANG PROPOSAL TUGAS AKHIR
        </div>

        <div class="info">
            <p>Pada hari ini, {{ \Carbon\Carbon::parse($jadwal->tanggal)->translatedFormat('d F Y') }} bertempat di Kampus Politeknik Negeri Cilacap
                    telah melaksanakan Sidang Proposal Tugas Akhir Mahasiswa:</p>
            ...
            <p>Dalam pelaksanaan Sidang Proposal Tugas Akhir ini mahasiswa bersangkutan diuji oleh Tim Penguji yang terdiri dari:</p>
            ...
            <p>Dan berdasarkan hasil evaluasi, maka proposal tugas akhir mahasiswa tersebut dinyatakan:</p>
            ...
            <table class="table-ttd">
                <tr>
                    <td  class="col-jabatan" style="height: 0px; padding: 5px;"></td>
                    <td class="col-ttd td-center" style="height: 0px; padding: 5px; text-align: center;">Tanda Tangan</td>
                </tr>
                <tr>
