            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {projects.map((project) => (
                <Link
                  ...
                  className="group bg-white rounded-2xl border border-gray-200/60 overflow-hidden hover:border-gray-300 hover:shadow-sm transition-all"
                >
                  {project.url_gambar ? (
                  ...
                  <div className="p-6">
                    <h3 className="text-[17px] font-semibold text-gray-900 mb-2 line-clamp-1">
                      {project.judul}
                    </h3>
        ...
        {user?.role === 'Mahasiswa' && (
          <div className="bg-white rounded-2xl border border-gray-200/60 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link 
                to="/my-projects/new" 
                className="bg-blue-600 text-white px-6 py-4 rounded-xl hover:bg-blue-700 transition-colors text-center font-medium text-[15px]"
              >
                Create New Project
              </Link>
              <Link 
                to="/my-projects" 
                className="bg-gray-100 text-gray-900 px-6 py-4 rounded-xl hover:bg-gray-200 transition-colors text-center font-medium text-[15px]"
              >
                Manage My Projects
              </Link>
            </div>
